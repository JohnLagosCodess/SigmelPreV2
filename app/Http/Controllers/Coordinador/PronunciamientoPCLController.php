...
class PronunciamientoPCLController extends Controller
{
    ...
    public function mostrarVistaPronunciamiento(Request $request){
        ...
        'array_comunicados','caso_notificado','N_siniestro_evento', 'Id_servicio', 'arraylistado_documentos', 'Id_Asignacion','entidades_conocimiento', 'info_afp_conocimiento'));
    ...
    public function generarPdfProformaPro(Request $request) {
        ...
        if (isset($copia_afp_conocimiento)) {
            if($desicion_proforma == "proforma_acuerdo"){
                ...
                $datos_entidades_conocimiento = $this->globalService->informacionEntidadesConocimientoEvento($Id_Evento_pronuncia_corre, 'word');
            }
        ...
        if ($desicion_proforma == 'proforma_acuerdo') {
            ...
            $nombre_docx = "PCL_DESACUERDO_{$Asignacion_Pronuncia_corre}_{$Iden_afiliado_corre}_{$indicativo}.docx";

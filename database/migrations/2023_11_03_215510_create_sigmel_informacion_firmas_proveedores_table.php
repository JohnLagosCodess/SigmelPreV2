...
return new class extends Migration
{
    ...
    {
        Schema::connection('sigmel_gestiones')->create('sigmel_informacion_firmas_proveedores', function (Blueprint $table) {
    ...
    {
        Schema::dropIfExists('sigmel_informacion_firmas_proveedores');
    }
};

...
return new class extends Migration
{
    ...
    {
        Schema::connection('sigmel_gestiones')->create('sigmel_info_campimetria_ojo_der_eventos', function (Blueprint $table) {
    ...
    {
        Schema::dropIfExists('sigmel_info_campimetria_ojo_der_eventos');
    }
};

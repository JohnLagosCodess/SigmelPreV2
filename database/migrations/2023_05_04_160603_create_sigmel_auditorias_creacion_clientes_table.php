...
return new class extends Migration
{
    ...
    {
        Schema::connection('sigmel_auditorias')->create('sigmel_auditorias_creacion_clientes', function (Blueprint $table) {
            $table->increments('id');
    ...
    {
        Schema::dropIfExists('sigmel_auditorias_creacion_clientes');
    }
};

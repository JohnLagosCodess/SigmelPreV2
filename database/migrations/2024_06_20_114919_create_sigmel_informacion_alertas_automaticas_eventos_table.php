...
return new class extends Migration
{
    ...
    {
        Schema::connection('sigmel_gestiones')->create('sigmel_informacion_alertas_automaticas_eventos', function (Blueprint $table) {
            $table->increments('Id_alerta_automatica');    
            ...
            $table->datetime('F_accion_alerta_naranja')->nullable();
            $table->text('Porcentaje_alerta_roja')->nullable();
            $table->datetime('F_accion_alerta_roja')->nullable();
            $table->text('Estado_alerta_automatica')->nullable();              
    ...
    {
        Schema::dropIfExists('sigmel_informacion_alertas_automaticas_eventos');
    }
};

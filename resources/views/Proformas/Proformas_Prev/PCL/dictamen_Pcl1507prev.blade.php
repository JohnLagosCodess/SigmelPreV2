        ...
        <table class="tabla_dictamen">
            ...
            @if (count($array_datos_laboralmente_activo) > 0)                
                ...
                <tr>
                    ...
                    <td colspan="10" rowspan="1" class="centrar_dato_labels">Restricciones del rol laboral</td>
                ...
                <tr>
                    ...
                    <td colspan="10" rowspan="1" class="centrar_dato_labels">Restricciones autosuficiencia económica</td>
                    <td colspan="1" class="centrar_dato_dinamico">
                        <b>0,0</b><br>
                ...
                <tr>
                    ...
                    <td colspan="10" rowspan="1" class="centrar_dato_labels">Restricciones en función de la edad cronológica</td>
                ...
                <tr>
                    ...
                    <td class="centrar_dato_dinamico"><?php if(!empty($array_datos_laboralmente_activo[0]->Total_rol_laboral)) {echo $array_datos_laboralmente_activo[0]->Total_rol_laboral;} else{echo '0.0';}?></td>
                </tr>                
                <tr>
                    <td colspan="17" class="titulo_tablas"><b>CALIFICACIÓN OTRAS ÁREAS OCUPACIONALES</b></td>
                </tr>
                <tr>
                    <td colspan="17" class="dato_dinamico">Valor según el grado de dificultad, ayuda y dependencia</td>
                </tr>
                <tr>
                    <td colspan="2" class="centrar_titulo_labels">CLASE</td>
                    <td colspan="2" class="centrar_titulo_labels">VALOR</td>
                    <td colspan="13" class="centrar_titulo_labels">CRITERIO CUALITATIVO</td>
                </tr>
                <tr>
                    <td colspan="2" class="centrar_dato_labels">A</td>
                    <td colspan="2" class="centrar_dato_labels">0,0</td>
                    <td colspan="13" class="centrar_dato_labels">No hay dificultad, No dependencia</td>
                </tr>
                <tr>
                    <td colspan="2" class="centrar_dato_labels">B</td>
                    <td colspan="2" class="centrar_dato_labels">0,1</td>
                    <td colspan="13" class="centrar_dato_labels">Dificultad leve, No dependencia</td>
                </tr>
                <tr>
                    <td colspan="2" class="centrar_dato_labels">C</td>
                    <td colspan="2" class="centrar_dato_labels">0,2</td>
                    <td colspan="13" class="centrar_dato_labels">Dificultad moderada, dependencia moderada</td>
                </tr>
                <tr>
                    <td colspan="2" class="centrar_dato_labels">D</td>
                    <td colspan="2" class="centrar_dato_labels">0,3</td>
                    <td colspan="13" class="centrar_dato_labels">Dificultad severa, dependencia severa</td>
                </tr>
                <tr>
                    <td colspan="2" class="centrar_dato_labels">E</td>
                    <td colspan="2" class="centrar_dato_labels">0,4</td>
                    <td colspan="13" class="centrar_dato_labels">Dificultad completa, dependencia completa</td>
                </tr>
                <tr>
                    <td colspan="17"></td>
                </tr>
                <tr>
                    ...
                    <td colspan="1" rowspan="1" class="label_area_ocupacional">Total</td>
                </tr>
                <tr>
                ...
                <tr>
                    ...
                    <td class="centrar_dato_dinamico">
                        <?php
            ...
            @elseif(count($array_datos_rol_ocupacional) > 0)
                <tr>
                    <td colspan="17" class="titulo_tablas">TITULO II</td>
                </tr>
                @if (!empty($array_datos_rol_ocupacional[0]->Poblacion_calificar) && $array_datos_rol_ocupacional[0]->Poblacion_calificar == 75)
                    <tr>
                        <td colspan="17" class="sinborderinferior dato_dinamico">Asigne el valor según grado de dificultad</td>
                    </tr>
                    <tr>
                        <td colspan="2" class="centrar_titulo_labels">CLASE</td>
                        <td colspan="2" class="centrar_titulo_labels">VALOR</td>
                    ...
                    <tr>
                        <td colspan="2" class="centrar_dato_labels">A</td>
                        <td colspan="2" class="centrar_dato_labels">0,0</td>
                        <td colspan="13" class="centrar_dato_labels">No hay dificultad, no hay dependencia </td>
                    </tr>
                    <tr>
                        <td colspan="2" class="centrar_dato_labels">B</td>
                        <td colspan="2" class="centrar_dato_labels">0,1</td>
                    ...
                    <tr>
                        <td colspan="2" class="centrar_dato_labels">C</td>
                        <td colspan="2" class="centrar_dato_labels">0,2</td>
                        <td colspan="13" class="centrar_dato_labels">Dificultad completa, dependencia grave / completa </td>
                    </tr>                
                    <tr>
                        <td colspan="17" class="sinborder"></td>
                    </tr>
                    <tr>
                        <td colspan="17" class="titulo_tablas">TABLA 12 - Valoración para Niños y Niñas de 0 a 3 años</td>
                    </tr>
                    <tr>
                        <td colspan="17" rowspan="1" class="label_area_ocupacional">Actividad Motriz</td>                        
                    </tr>
                    <tr>
                        ...
                        <td colspan="2" class="label_rol_laboral">Sujeta la cabeza</td>
                    ...
                    <tr>
                        ...
                        <td colspan="2" class="label_rol_laboral">Se mantiene de pie sin apoyo</td>
                    ...
                    <tr>
                        <td colspan="17" rowspan="1" class="label_area_ocupacional">Actividad Adaptativa</td>                        
                    </tr>
                    <tr>
                        <td colspan="3" class="label_rol_laboral">Succiona</td>
                        <td colspan="2" class="label_rol_laboral">Fija la mirada</td>
                        <td colspan="2" class="label_rol_laboral">Sigue la trayectoria de un objeto</td>
                    ...
                    <tr>
                        ...
                        <td colspan="2" class="label_rol_laboral">Se quita una prenda de vestir</td>
                    ...
                    <tr>
                        ...
                        <td colspan="10" class="right_titulo_labels"><b>Sumatoria área motriz + Sumatoria área adaptativa:</b></td>
                        <td colspan="2" class="centrar_dato_dinamico">
                            <?php 
                ...
                @elseif(!empty($array_datos_rol_ocupacional[0]->Poblacion_calificar) && $array_datos_rol_ocupacional[0]->Poblacion_calificar == 76)
                    <tr>
                        <td colspan="17" class="dato_dinamico">Asigne valor único del rol ocupacional e integrar la información de la ejecución de las áreas ocupacionales o AVD</td>
                    </tr>
                    <tr>
                        <td colspan="17" class="titulo_tablas">TABLA 13 - Valoración de los roles ocupacionales de juego-estudio en niños y niñas mayores de tres años y adolescentes</td>
                    </tr>
                    <tr>
                    ...
                    <tr>
                        ...
                        <td colspan="1" class="centrar_dato_labels">A</td>
                    ...
                    <tr>
                        ...
                        <td colspan="1" class="centrar_dato_labels">B</td>
                    ...
                    <tr>
                        ...
                        <td colspan="1" class="centrar_dato_labels">C</td>
                    ...
                    <tr>
                        ...
                        <td colspan="1" class="centrar_dato_labels">D</td>
                    ...
                    <tr>
                        ...
                        <td colspan="1" class="centrar_dato_labels">E</td>
                    ...
                    <tr>
                        ...
                        <td colspan="1" class="centrar_dato_dinamico"><?php if(!empty($array_datos_rol_ocupacional[0]->Total_rol_estudio_clase)){echo $array_datos_rol_ocupacional[0]->Total_rol_estudio_clase;}else{echo '0.0';}?></td>
                    </tr>
                @elseif(!empty($array_datos_rol_ocupacional[0]->Poblacion_calificar) && $array_datos_rol_ocupacional[0]->Poblacion_calificar == 77)
                    ...
                    <tr>
                        <td colspan="17" class="titulo_tablas">TABLA 14 - Valoración de los roles ocupacional relacionado con el uso del tiempo libre y de esparcimiento en adultos mayores</td>
                    </tr>
                    <tr>
                        <td colspan="14" class="centrar_titulo_labels">CRITERIO CUALITATIVO</td>
                        <td colspan="1" class="centrar_titulo_labels">CLASE</td>
                    ...
                    <tr>
                        <td colspan="4" class="centrar_dato_labels"><b>CÁLCULO FINAL PCO</b></td>
                        <td colspan="12" class="right_titulo_labels"><b>Valor del rol asignado</b></td>
                        <td colspan="1" class="centrar_dato_dinamico"><?php if(!empty($array_datos_rol_ocupacional[0]->Total_rol_adultos_ayores)){echo $array_datos_rol_ocupacional[0]->Total_rol_adultos_ayores;}else{echo '0.0';}?></td>
                    </tr>
                @endif
            @endif
            <tr>
            ...
            <tr>
                ...
                <td colspan="13" class="dato_dinamico">{{$Justificacion_dependencia_dp}}</td>
            </tr>
            <tr>

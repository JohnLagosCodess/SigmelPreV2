                ...
                <tr>
                    <td class="fuente_todo_texto">
                        <div>
                            ...
                            <span class="negrita" style="margin-left: 1cm;">Ramo:</span> Previsionales<br>
                            <span style="margin-left: 1cm;">{{$tipo_identificacion.' '.$num_identificacion}}</span><br>                        
                            <span class="negrita" style="margin-left: 1cm;">Siniestro: </span>{{$N_siniestro}}
                        </div>
                    </td>
                </tr>
            </tbody>

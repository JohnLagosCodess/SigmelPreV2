...
<body>
    ...
    <div id="footer">
        <table class="tabla_footer">
            <tbody>
                <tr>
                    <td colspan="2" class="negrita" style="text-align: center;"><?php echo "{$nombre_afiliado} - {$tipo_identificacion} ({$num_identificacion}) - Siniestro: ({$id_evento})"; ?></td>
                </tr>
                <tr>
    ...
    <div class="container">
        ...
        <table class="tabla2">
            <tbody>
                <tr>
                    <td>
                        <span class="fuente_todo_texto"><span class="negrita">Señores: </span>{{$nombre_junta}}</span><br>
                        <span class="fuente_todo_texto"><span class="negrita">Dirección: </span>{{$direccion_junta}}</span><br>
                        <span class="fuente_todo_texto"><span class="negrita">Teléfono: </span>{{$telefono_junta}}</span><br>
                        <span class="fuente_todo_texto"><span class="negrita">Ciudad: </span>{{$ciudad_junta}} - {{$departamento_junta}}</span>
                    </td>
                    <td>
                        <div class="cuadro">
            ...
            <tbody>
                <tr>
                    <td>
                        ...
                        <br>
                        <span class="fuente_todo_texto"><span class="negrita">Siniestro: {{$id_evento}} {{$tipo_identificacion}} {{$num_identificacion}} {{$nombre_afiliado}}</span></span><br>
                    </td>
                </tr>
            </tbody>
        </table>
        <section class="fuente_todo_texto">
            <?php 
                ...
                if (preg_match($patron1, $cuerpo) && preg_match($patron2, $cuerpo) && preg_match($patron3, $cuerpo) &&
                    ...
                    $cuerpo_modificado = str_replace('{{$f_dictamen_jrci}}', "<b>".$f_dictamen_jrci_emitido."</b>", $cuerpo_modificado);

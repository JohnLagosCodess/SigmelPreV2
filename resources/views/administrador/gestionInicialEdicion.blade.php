...
@section('content')
    <div class="row">
        <div class="col-2">
            ...
            <input hidden="hidden" type="text" name="id_evento" id="id_evento" value="{{$newIdEvento}}">
            <input hidden="hidden" type="text" name="id_asignacion" id="id_asignacion" value="{{@$_POST['newIdAsignacion']}}">
        </div>
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="entidad_conocimiento_1 d-none col-3" id='container_entidad_conocimiento_1'>
                                                    <div class="form-group">
                                                        ...
                                                        <select class="custom-control" name="entidad_conocimiento_1" id="entidad_conocimiento_1"></select>
                                                ...
                                                <div class="entidad_conocimiento_2 col-3 d-none" id='container_entidad_conocimiento_2'>
                                                    <div class="form-group">
                                                        ...
                                                        <select class="custom-control" name="entidad_conocimiento_2" id="entidad_conocimiento_2"></select>
                                                ...
                                                <div class="entidad_conocimiento_3 col-3 d-none" id='container_entidad_conocimiento_3'>
                                                    <div class="form-group">
                                                        ...
                                                        <select class="custom-control" name="entidad_conocimiento_3" id="entidad_conocimiento_3"></select>
                                                ...
                                                <div class="entidad_conocimiento_4 col-3 d-none" id='container_entidad_conocimiento_4'>
                                                    <div class="form-group">
                                                        ...
                                                        <select class="custom-control" name="entidad_conocimiento_4" id="entidad_conocimiento_4"></select>
                                                ...
                                                <div class="entidad_conocimiento_5 col-3 d-none" id='container_entidad_conocimiento_5'>
                                                    <div class="form-group">
                                                        ...
                                                        <select class="custom-control" name="entidad_conocimiento_5" id="entidad_conocimiento_5"></select>
                                                ...
                                                <div class="entidad_conocimiento_6 col-3 d-none" id='container_entidad_conocimiento_6'>
                                                    <div class="form-group">
                                                        ...
                                                        <select class="custom-control" name="entidad_conocimiento_6" id="entidad_conocimiento_6"></select>
                                                ...
                                                <div class="entidad_conocimiento_7 col-3 d-none" id='container_entidad_conocimiento_7'>
                                                    <div class="form-group">
                                                        ...
                                                        <select class="custom-control" name="entidad_conocimiento_7" id="entidad_conocimiento_7"></select>
                                                ...
                                                <div class="entidad_conocimiento_8 col-3 d-none" id='container_entidad_conocimiento_8'>
                                                    <div class="form-group">
                                                        ...
                                                        <select class="custom-control" name="entidad_conocimiento_8" id="entidad_conocimiento_8"></select>

            ...
            <form id="form_agregar_agudeza_auditiva" method="POST">
                ...
                <div class="card-info" style="border: 1.5px solid black; border-radius: 2px;">
                    <div class="card-header text-center">
                        ...
                        <input hidden="hidden" type="text" id="ID_evento" name="ID_evento" value="{{$array_datos_RecalificacionPcl[0]->ID_evento}}">
                        <input hidden="hidden" type="text" id="Id_Asignacion" name="Id_Asignacion" value="{{$array_datos_RecalificacionPcl[0]->Id_Asignacion}}">
                        <input hidden="hidden" type="text" id="Id_proceso" name="Id_proceso" value="{{$array_datos_RecalificacionPcl[0]->Id_proceso}}">
                    </div>
                    <div class="card-body">                                
                        <div class="row">
                            <div class="col-6">

<x-adminlte-modal id="modal_nueva_agudeza_visual" class="modalscroll" title="Agudeza Visual" theme="info" icon="fas fa-plus-circle" size='xl' disable-animations>
    ...
    <form id="form_agudeza_visual" method="POST">
        @csrf
        <div class="d-none">
            <input type="text" id="ID_evento" name="ID_evento" value="{{$array_datos_RecalificacionPcl[0]->ID_evento}}">
            <input type="text" id="Id_Asignacion" name="Id_Asignacion" value="{{$array_datos_RecalificacionPcl[0]->Id_Asignacion}}">
            <input type="text" id="Id_proceso" name="Id_proceso" value="{{$array_datos_RecalificacionPcl[0]->Id_proceso}}">
...
<script type="text/javascript" src="/js/campimetria_re.js"></script>
@stop
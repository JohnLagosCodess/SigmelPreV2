                        ...
                        <div class="card-body">
                            <form id="form_guardarEmitidoJrci" method="POST">
                                ...
                                <div class="row">
                                   ...
                                   <div class="col-12">
                                        <form  id="form_diagnostico_controvertido" method="POST">
                                            <div class="alert alert-warning mensaje_confirmacion_controvertido" role="alert">
                                                <i class="fas fa-info-circle"></i> <strong>Importante:</strong> Al momento de agregar una fila nueva es necesario
                                                que diligencie en su totalidad los campos.
                                            </div>
                                                    ...
                                                    <tbody>
                                                        {{-- @if (!empty($array_datos_diagnostico_motcalifi))
                                                            ...
                                                            <tr class="fila_diagnosticos_{{$diagnostico->Id_Diagnosticos_motcali}}" id="datos_diagnostico">
                                                                ...
                                                                <td>
                                                                    <div style="text-align:center;"><a href="javascript:void(0);" id="btn_remover_diagnosticos_jrci_emitido{{$diagnostico->Id_Diagnosticos_motcali}}" data-id_fila_quitar="{{$diagnostico->Id_Diagnosticos_motcali}}" data-clase_fila="fila_diagnosticos_{{$diagnostico->Id_Diagnosticos_motcali}}" class="text-info"><i class="fas fa-minus-circle" style="font-size:24px;"></i></a></div>
                                                                </td>
                                                            </tr> 
                                                            @endforeach
                                                        @endif --}}
                        ...
                        <div class="card-body">
                            <form id="form_guardarRevisionjrci" method="POST">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-12">
                                        <div class="form-group">
                                            <label for="sustentacion_concepto_jrci">Sustentación ante concepto de la JRCI</span></label>
                                ...
                                <div class="row">
                                    <div class="col-6">
                                        <div class="form-group">
                                            <input type="submit" id="guardar_datos_concepto_jrci" class="btn btn-info" value="Guardar">
                                        </div>
                                    </div>
                                    <div class="col-12">
                                        <div class="alerta_controvertido alert alert-success mt-2 mr-auto d-none" role="alert"></div>
                                ...
                                <div class="row">
                                    <div class="col-4">
                                        <div class="form-group">
                                            ...
                                            <input type="date" class="form-control" name="f_notificacion_recurso_jrci" id="f_notificacion_recurso_jrci" max="{{now()->format('Y-m-d')}}" value="<?php if(!empty($arrayinfo_controvertido[0]->F_notificacion_recurso_jrci)) { echo $arrayinfo_controvertido[0]->F_notificacion_recurso_jrci;} ?>">
                                        </div>
                                    </div>
                                    <div class="col-4">
                                        <div class="form-group">
                                            <label for="n_radicado_recurso_jrci">N° radicado de recurso ante JRCI<span style="color: red;">(*)</span></label>
                                            <input type="date" class="form-control" name="n_radicado_recurso_jrci" id="n_radicado_recurso_jrci" max="{{now()->format('Y-m-d')}}" value="<?php if(!empty($arrayinfo_controvertido[0]->N_radicado_recurso_jrci)) { echo $arrayinfo_controvertido[0]->N_radicado_recurso_jrci;} ?>">
                                        </div>
                                    </div>
                                    <div class="col-4">
                                        <div class="form-group">
                                            <label for="termino_contro_propia_jrci">Término de controversia propia ante JRCI<span style="color: red;">(*)</span></label>
                                            <input type="date" class="form-control" name="termino_contro_propia_jrci" id="termino_contro_propia_jrci" max="{{now()->format('Y-m-d')}}" value="<?php if(!empty($arrayinfo_controvertido[0]->Termino_contro_propia_jrci)) { echo $arrayinfo_controvertido[0]->Termino_contro_propia_jrci;} ?>">
                                        </div>
                                    </div>
                                </div>
                                <div class="row">
                            ...
                            <form id="form_guardarInteresadajrci" method="POST">
                                ...
                                <div class="row">
                                    <div class="col-6">
                                        <div class="form-group">
                                            <div class="custom-control custom-checkbox">
                                                <input class="custom-control-input" type="checkbox" id="firmeza_intere_contro_jrci" name="firmeza_intere_contro_jrci" value="Controversia ante JRCI" {{-- @if (!empty($arrayinfo_controvertido[0]->Contro_origen) && $arrayinfo_controvertido[0]->Contro_origen=='Origen') checked @endif --}} >
                                    ...
                                    <div class="col-6">
                                        <div class="form-group">
                                            <div class="custom-control custom-checkbox">
                                                <input class="custom-control-input" type="checkbox" id="firmeza_reposicion_jrci" name="firmeza_reposicion_jrci" value="Reposición por parte JRCI" {{-- @if (!empty($arrayinfo_controvertido[0]->Contro_origen) && $arrayinfo_controvertido[0]->Contro_origen=='Origen') checked @endif --}} >
                                    ...
                                    <div class="col-6">
                                        <div class="form-group">
                                            <div class="custom-control custom-checkbox">
                                                <input class="custom-control-input" type="checkbox" id="firmeza_acta_ejecutoria_jrci" name="firmeza_acta_ejecutoria_jrci" value="Registra Ejecutoria JRCI" {{-- @if (!empty($arrayinfo_controvertido[0]->Contro_origen) && $arrayinfo_controvertido[0]->Contro_origen=='Origen') checked @endif --}} >
                                    ...
                                    <div class="col-6">
                                        <div class="form-group">
                                            <div class="custom-control custom-checkbox">
                                                <input class="custom-control-input" type="checkbox" id="firmeza_apelacion_jnci_jrci" name="firmeza_apelacion_jnci_jrci" value="Apelación JNCI a JRCI" {{-- @if (!empty($arrayinfo_controvertido[0]->Contro_origen) && $arrayinfo_controvertido[0]->Contro_origen=='Origen') checked @endif --}} >
                                ...
                                <div class="row">
                                    <div class="col-6">
                                        <div class="form-group">
                                            <input type="submit" id="guardar_datos_firmeza_jrci" class="btn btn-info" value="Guardar">
                                        </div>
                                    </div>
                                    <div class="col-12">
                                        <div class="alerta_controvertido alert alert-success mt-2 mr-auto d-none" role="alert"></div>
                        ...
                        <div class="card-body">
                            <form id="form_guardarOtraJRCI" method="POST">
                                ...
                                <div class="row">
                                    <div class="col-4">
                                        <div class="form-group">
                                            ...
                                            <select class="custom-select parte_contro_ante_jrci" name="parte_contro_ante_jrci" id="parte_contro_ante_jrci" style="width: 100%;">
                                                {{-- @if (!empty($arrayinfo_controvertido[0]->Manual_de_califi_jrci_emitido))
                                                        <option value="{{$arrayinfo_controvertido[0]->Manual_de_califi_jrci_emitido}}" selected>{{$arrayinfo_controvertido[0]->Nombre_decretoJrci}}</option>
                                                @else
                                                    <option value="">Seleccione una opción</option>
                                    ...
                                    <div class="col-4">
                                        <div class="form-group">
                                            ...
                                            <input type="text" class="form-control soloPrimeraLetraMayus" name="nombre_presen_contro_jrci" id="nombre_presen_contro_jrci" value="{{-- <?php if(!empty($arrayinfo_controvertido[0]->Rango_pcl_jrci_emitido)) { echo $arrayinfo_controvertido[0]->Rango_pcl_jrci_emitido;} ?> --}}">
                                        </div>
                                    </div>
                                    <div class="col-4">
                                        <div class="form-group">
                                            ...
                                            <input type="date" class="form-control" name="f_contro_otra_jrci" id="f_contro_otra_jrci" max="{{now()->format('Y-m-d')}}" value="{{-- <?php if(!empty($arrayinfo_controvertido[0]->Rango_pcl_jrci_emitido)) { echo $arrayinfo_controvertido[0]->Rango_pcl_jrci_emitido;} ?> --}}">
                                        </div>
                                    </div>
                                    <div class="col-12">
                                        <div class="form-group">
                                    ...
                                    <div class="col-2">
                                        <div class="form-group">
                                            <div class="custom-control custom-checkbox">
                                                <input class="custom-control-input" type="checkbox" id="contro_origen_jrci" name="contro_origen_jrci" value="Origen"{{--  @if (!empty($arrayinfo_controvertido[0]->Contro_origen) && $arrayinfo_controvertido[0]->Contro_origen=='Origen') checked @endif --}}>
                                    ...
                                    <div class="col-2">
                                        <div class="form-group">
                                            <div class="custom-control custom-checkbox">
                                                <input class="custom-control-input" type="checkbox" id="contro_pcl_jrci" name="contro_pcl_jrci" value="% PCL" {{-- @if (!empty($arrayinfo_controvertido[0]->Contro_pcl) && $arrayinfo_controvertido[0]->Contro_pcl=='% PCL') checked @endif --}}>
                                    ...
                                    <div class="col-2">
                                        <div class="form-group">
                                            <div class="custom-control custom-checkbox">
                                                <input class="custom-control-input" type="checkbox" id="contro_diagnostico_jrci" name="contro_diagnostico_jrci" value="Diagnósticos" {{-- @if (!empty($arrayinfo_controvertido[0]->Contro_diagnostico) && $arrayinfo_controvertido[0]->Contro_diagnostico=='Diagnósticos') checked @endif --}}>
                                    ...
                                    <div class="col-3">
                                        <div class="form-group">
                                            <div class="custom-control custom-checkbox">
                                                <input class="custom-control-input" type="checkbox" id="contro_f_estructura_jrci" name="contro_f_estructura_jrci" value="Fecha estructuración" {{-- @if (!empty($arrayinfo_controvertido[0]->Contro_f_estructura) && $arrayinfo_controvertido[0]->Contro_f_estructura=='Fecha estructuración') checked @endif --}}>
                                    ...
                                    <div class="col-3">
                                        <div class="form-group">
                                            <div class="custom-control custom-checkbox">
                                                <input class="custom-control-input" type="checkbox" id="contro_m_califi_jrci" name="contro_m_califi_jrci" value="Manual de calificación" {{-- @if (!empty($arrayinfo_controvertido[0]->Contro_m_califi) && $arrayinfo_controvertido[0]->Contro_m_califi=='Manual de calificación') checked @endif --}}>
                                ...
                                <div class="row">
                                    <div class="col-6">
                                        <div class="form-group">
                                            <input type="submit" id="guardar_datos_interasa_jrci" class="btn btn-info" value="Guardar">
                                        </div>
                                    </div>
                                    <div class="col-12">
                                        <div class="alerta_controvertido alert alert-success mt-2 mr-auto d-none" role="alert"></div>
                            ...
                            <form id="form_guardarReposicionJRCI" method="POST">
                                ...
                                <div class="row">
                                    <div class="col-2">
                                        ...
                                        <input class="scalesR" type="radio" name="reposicion_dictamen_jrci" id="reposi_propio_jrci" value="Propio" style="margin-left: revert;">
                                    </div>
                                    <div class="col-3">
                                        <br>
                                        <label for="reposi_otras_parte_jrci"><strong>Otra parte interesada</strong></label>
                                        <input class="scalesR" type="radio" name="reposicion_dictamen_jrci" id="reposi_otras_parte_jrci" value="Otra parte interesada" style="margin-left: revert;">
                                    </div>
                                    <div class="col-3">
                                        <div class="form-group">
                                            <label for="n_dictamen_reposicion_jrci">N° Dictamen (Reposición JRCI)<br><span style="color: red;">(*)</span></label>
                                            <input type="number" class="form-control soloNumeros" name="n_dictamen_reposicion_jrci" id="n_dictamen_reposicion_jrci" value="{{-- <?php if(!empty($arrayinfo_controvertido[0]->Rango_pcl_jrci_emitido)) { echo $arrayinfo_controvertido[0]->Rango_pcl_jrci_emitido;} ?> --}}">
                                        </div>
                                    </div>
                                    <div class="col-3">
                                        <div class="form-group">
                                            <label for="f_dictamen_reposicion_jrci">Fecha Dictamen (Reposición JRCI)<span style="color: red;">(*)</span></label>
                                            <input type="date" class="form-control" name="f_dictamen_reposicion_jrci" id="f_dictamen_reposicion_jrci" max="{{now()->format('Y-m-d')}}" value="{{-- <?php if(!empty($arrayinfo_controvertido[0]->Rango_pcl_jrci_emitido)) { echo $arrayinfo_controvertido[0]->Rango_pcl_jrci_emitido;} ?> --}}">
                                        </div>
                                    </div>
                                    <div class="col-12">
                                        <form  id="form_diagnostico_controvertido" method="POST">
                                    ...
                                    <div class="col-4">
                                        <div class="form-group">
                                            ...
                                            <input type="text" class="form-control soloDosDecimales" name="total_deficiencia_reposicion_jrci" id="total_deficiencia_reposicion_jrci" value="{{-- <?php if(!empty($arrayinfo_controvertido[0]->Rango_pcl_jrci_emitido)) { echo $arrayinfo_controvertido[0]->Rango_pcl_jrci_emitido;} ?> --}}">
                                        </div>
                                    </div>
                                    <div class="col-4">
                                        <div class="form-group">
                                            <label for="total_rol_reposicion_jrci">Total Rol ocupacional (Reposición JRCI)<span style="color: red;">(*)</span></label>
                                            <input type="text" class="form-control soloDosDecimales" name="total_rol_reposicion_jrci" id="total_reposicion_jrci" value="{{-- <?php if(!empty($arrayinfo_controvertido[0]->Rango_pcl_jrci_emitido)) { echo $arrayinfo_controvertido[0]->Rango_pcl_jrci_emitido;} ?> --}}">
                                        </div>
                                    </div>
                                    <div class="col-4">
                                        <div class="form-group">
                                            <label for="total_discapacidad_reposicion_jrci">Total Discapacidad (Reposición JRCI)<span style="color: red;">(*)</span></label>
                                            <input tsype="text" class="form-control soloDosDecimales" name="total_discapacidad_reposicion_jrci" id="total_discapacidad_reposicion_jrci" value="{{-- <?php if(!empty($arrayinfo_controvertido[0]->Rango_pcl_jrci_emitido)) { echo $arrayinfo_controvertido[0]->Rango_pcl_jrci_emitido;} ?> --}}">
                                        </div>
                                    </div>
                                    <div class="col-4">
                                        <div class="form-group">
                                            <label for="total_minusvalia_reposicion_jrci">Total Minusvalía (Reposición JRCI)<span style="color: red;">(*)</span></label>
                                            <input tsype="text" class="form-control soloDosDecimales" name="total_minusvalia_reposicion_jrci" id="total_minusvalia_reposicion_jrci" value="{{-- <?php if(!empty($arrayinfo_controvertido[0]->Rango_pcl_jrci_emitido)) { echo $arrayinfo_controvertido[0]->Rango_pcl_jrci_emitido;} ?> --}}">
                                        </div>
                                    </div>
                                    <div <?php if(!empty($arrayinfo_controvertido[0]->Contro_pcl)){ ?> class="col-4" <?php }else{ ?> class="col-4 text-center d-none" <?php } ?>>
                                        <div class="form-group">
                                            ...
                                            <input type="number" class="form-control" name="porcentaje_pcl_reposicion_jrci" id="porcentaje_pcl_reposicion_jrci" value="{{-- <?php if(!empty($arrayinfo_controvertido[0]->Porcentaje_pcl_jrci_emitido)) { echo $arrayinfo_controvertido[0]->Porcentaje_pcl_jrci_emitido;} ?> --}}" readonly>
                                        </div>
                                    </div>
                                    <div <?php if(!empty($arrayinfo_controvertido[0]->Contro_pcl)){ ?> class="col-4" <?php }else{ ?> class="col-4 text-center d-none" <?php } ?>>
                                        <div class="form-group">
                                            ...
                                            <input type="text" class="form-control" name="rango_pcl_reposicion_jrci" id="rango_pcl_reposicion_jrci" value="{{-- <?php if(!empty($arrayinfo_controvertido[0]->Rango_pcl_jrci_emitido)) { echo $arrayinfo_controvertido[0]->Rango_pcl_jrci_emitido;} ?> --}}" readonly>
                                        </div>
                                    </div>
                                   <div  <?php if(!empty($arrayinfo_controvertido[0]->Contro_pcl)){ ?> class="col-4" <?php }else{ ?> class="col-4 text-center d-none" <?php } ?>>
                                        <div class="form-group">
                                            ...
                                            <input type="date" class="form-control" name="f_estructuracion_contro_reposicion_jrci" id="f_estructuracion_contro_reposicion_jrci" max="{{now()->format('Y-m-d')}}" value="{{-- <?php if(!empty($arrayinfo_controvertido[0]->F_estructuracion_contro_jrci_emitido)) { echo $arrayinfo_controvertido[0]->F_estructuracion_contro_jrci_emitido;} ?> --}}">
                                        </div>
                                    </div>
                                    <div class="col-12">
                                        <div class="form-group">
                                            <label for="resumen_dictamen_reposicion_jrci">Resumen Dictamen (JRCI)</span></label>
                                            <textarea class="form-control soloPrimeraLetraMayus" name="resumen_dictamen_reposicion_jrci " id="resumen_dictamen_reposicion_jrci" cols="30" rows="5" style="resise:none;" required>{{-- <?php if(!empty($arrayinfo_controvertido[0]->Resumen_dictamen_jrci)) { echo $arrayinfo_controvertido[0]->Resumen_dictamen_jrci;} ?> --}}</textarea>
                                        </div>
                                    </div>
                                    <div class="col-4">
                                        <div class="form-group">
                                            ...
                                            <input type="date" class="form-control" name="f_noti_dictamen_reposicion_jrci" id="f_noti_dictamen_reposicion_jrci" max="{{now()->format('Y-m-d')}}" value="{{-- <?php if(!empty($arrayinfo_controvertido[0]->F_noti_dictamen_jrci)) { echo $arrayinfo_controvertido[0]->F_noti_dictamen_jrci;} ?> --}}">
                                        </div>
                                    </div>
                                    <div class="col-4">
                                        <div class="form-group">
                                            ...
                                            <input type="date" class="form-control" name="f_radica_dictamen_reposicion_jrci" id="f_radica_dictamen_reposicion_jrci" max="{{now()->format('Y-m-d')}}" value="<?php if(!empty($arrayinfo_controvertido[0]->F_radica_dictamen_jrci)) { echo $arrayinfo_controvertido[0]->F_radica_dictamen_jrci;} ?>">
                                        </div>
                                    </div>
                                    <div class="col-4">
                                        <div class="form-group">
                                            ...
                                            <input type="date" class="form-control" name="f_maxima_apelacion_jrci" id="f_maxima_apelacion_jrci" value="<?php if(!empty($arrayinfo_controvertido[0]->F_maxima_recurso_jrci)) { echo $arrayinfo_controvertido[0]->F_maxima_recurso_jrci;} ?>" readonly>
                                        </div>
                                    </div>
                                </div>
                                <div class="row">
                            ...
                            <form id="form_guardarRevisionRecursojrci" method="POST">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-2">
                                        <div class="form-group">
                                            <div class="form-check custom-control custom-radio">
                                                <input class="form-check-input custom-control-input custom-control-input-info" type="radio" name="pronuncia_dictamen_jrci" id="acuerdo_reposicion_jrci" value="Acuerdo" <?php if(!empty($arrayinfo_controvertido[0]->Decision_dictamen_jrci) && $arrayinfo_controvertido[0]->Decision_dictamen_jrci=='Acuerdo'){ ?> checked <?php } ?>>
                                                <label class="form-check-label custom-control-label" for="acuerdo_reposicion_jrci"><strong>Acuerdo</strong></label>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="col-2">
                                        <div class="form-group">
                                            <div class="form-check custom-control custom-radio">
                                                <input class="form-check-input custom-control-input custom-control-input-info" type="radio" name="pronuncia_dictamen_jrci" id="desacuerdo_reposicion_jrci" value="Desacuerdo" <?php if(!empty($arrayinfo_controvertido[0]->Decision_dictamen_jrci) && $arrayinfo_controvertido[0]->Decision_dictamen_jrci=='Desacuerdo'){ ?> checked <?php } ?>>
                                                <label class="form-check-label custom-control-label" for="desacuerdo_reposicion_jrci"><strong>Desacuerdo</strong></label>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="col-2">
                                        <div class="form-group">
                                            <div class="form-check custom-control custom-radio">
                                                <input class="form-check-input custom-control-input custom-control-input-info" type="radio" name="pronuncia_dictamen_jrci" id="silecion_reposicion_jrci" value="Silencio" <?php if(!empty($arrayinfo_controvertido[0]->Decision_dictamen_jrci) && $arrayinfo_controvertido[0]->Decision_dictamen_jrci=='Silencio'){ ?> checked <?php } ?>>
                                                <label class="form-check-label custom-control-label" for="silecion_reposicion_jrci"><strong>Silencio</strong></label>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="col-2">
                                        <div class="form-group">
                                            <div class="form-check custom-control custom-radio">
                                                <input class="form-check-input custom-control-input custom-control-input-info" type="radio" name="pronuncia_dictamen_jrci" id="informativo_reposicion_jrci" value="Informativo" <?php if(!empty($arrayinfo_controvertido[0]->Decision_dictamen_jrci) && $arrayinfo_controvertido[0]->Decision_dictamen_jrci=='Informativo'){ ?> checked <?php } ?>>
                                                <label class="form-check-label custom-control-label" for="informativo_reposicion_jrci"><strong>Informativo</strong></label>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="col-12">
                                        <div class="form-group">
                                            <br>
                                            <label for="causal_decision_repo_jrci">Causal de decisión (Reposición JRCI)<span style="color: red;">(*)</span></label>
                                            <select class="custom-select causal_decision_repo_jrci" name="causal_decision_repo_jrci" id="causal_decision_repo_jrci" style="width: 100%;">
                                                {{-- @if (!empty($arrayinfo_controvertido[0]->Origen_controversia))
                                                        <option value="{{$arrayinfo_controvertido[0]->Origen_controversia}}" selected>{{$arrayinfo_controvertido[0]->OrigenContro}}</option>
                                                @else
                                                    <option value="">Seleccione una opción</option>
                                    ...
                                    <div class="col-12">
                                        <div class="form-group">
                                            <label for="sustentacion_reposicion_jrci">Sustentación ante recurso de reposición de la JRCI</span></label>
                                            <textarea class="form-control soloPrimeraLetraMayus" name="sustentacion_reposicion_jrci " id="sustentacion_reposicion_jrci" cols="30" rows="5" style="resise:none;" required><?php if(!empty($arrayinfo_controvertido[0]->Sustentacion_concepto_jrci)) { echo $arrayinfo_controvertido[0]->Sustentacion_concepto_jrci;} ?></textarea>
                                        </div>
                                    </div>
                                    <div class="col-4">
                                        <div class="form-group">
                                            <br>
                                            <label for="f_sustenta_reposicion_jrci">Fecha de sustentación ante recurso de reposición de la JRCI</label>
                                            <input type="date" class="form-control" name="f_sustenta_reposicion_jrci" id="f_sustenta_reposicion_jrci" value="<?php if(!empty($arrayinfo_controvertido[0]->F_sustenta_jrci)) { echo $arrayinfo_controvertido[0]->F_sustenta_jrci;} ?>" readonly>
                                        </div>
                                    </div>
                                </div>
                                <div class="row">
                                ...
                                <div class="row">
                                    <div class="col-4">
                                        <div class="form-group">
                                            ...
                                            <input type="date" class="form-control" name="f_noti_apela_recurso_jrci" id="f_noti_apela_recurso_jrci" max="{{now()->format('Y-m-d')}}" value="{{-- <?php if(!empty($arrayinfo_controvertido[0]->Rango_pcl_jrci_emitido)) { echo $arrayinfo_controvertido[0]->Rango_pcl_jrci_emitido;} ?> --}}">
                                        </div>
                                    </div>
                                    <div class="col-4">
                                        <div class="form-group">
                                            <label for="n_radicado_apela_recurso_jrci">N° radicado de apelación de recurso ante JRCI<span style="color: red;">(*)</span></label>
                                            <input type="text" class="form-control" name="n_radicado_apela_recurso_jrci" id="n_radicado_apela_recurso_jrci" value="{{-- <?php if(!empty($arrayinfo_controvertido[0]->Rango_pcl_jrci_emitido)) { echo $arrayinfo_controvertido[0]->Rango_pcl_jrci_emitido;} ?> --}}">
                                        </div>
                                    </div>
                                    <div class="col-4">
                                        <div class="form-group">
                                            ...
                                            <input type="text" class="form-control" name="t_propia_apela_recurso_jrci" id="t_propia_apela_recurso_jrci" value="{{-- <?php if(!empty($arrayinfo_controvertido[0]->Rango_pcl_jrci_emitido)) { echo $arrayinfo_controvertido[0]->Rango_pcl_jrci_emitido;} ?> --}}" readonly>
                                        </div>
                                    </div>
                                    <div class="col-12">
                                        <div class="form-group">
                                            <div class="custom-control custom-checkbox">
                                                <input class="custom-control-input" type="checkbox" id="correspon_pago_jnci" name="correspon_pago_jnci" value="Corresponde pago a JNCI" @if (!empty($arrayinfo_controvertido[0]->Contro_origen) && $arrayinfo_controvertido[0]->Contro_origen=='Origen') checked @endif>
                                    ...
                                    <div class="col-4">
                                        <div class="form-group">
                                            ...
                                            <input type="text" class="form-control" name="n_orden_pago_jnci" id="n_orden_pago_jnci" value="{{-- <?php if(!empty($arrayinfo_controvertido[0]->Rango_pcl_jrci_emitido)) { echo $arrayinfo_controvertido[0]->Rango_pcl_jrci_emitido;} ?> --}}">
                                        </div>
                                    </div>
                                    <div class="col-4">
                                        <div class="form-group">
                                            <label for="f_orden_pago_jnci">Fecha pago (JNCI)<span style="color: red;">(*)</span></label>
                                            <input type="date" class="form-control" name="f_orden_pago_jnci" id="f_orden_pago_jnci" max="{{now()->format('Y-m-d')}}" value="{{-- <?php if(!empty($arrayinfo_controvertido[0]->Rango_pcl_jrci_emitido)) { echo $arrayinfo_controvertido[0]->Rango_pcl_jrci_emitido;} ?> --}}">
                                        </div>
                                    </div>
                                    <div class="col-4">
                                        <div class="form-group">
                                            <label for="f_radi_pago_jnci">Fecha de radicación pago (JNCI)<span style="color: red;">(*)</span></label>
                                            <input type="date" class="form-control" name="f_radi_pago_jnci" id="f_radi_pago_jnci" max="{{now()->format('Y-m-d')}}" value="{{-- <?php if(!empty($arrayinfo_controvertido[0]->Rango_pcl_jrci_emitido)) { echo $arrayinfo_controvertido[0]->Rango_pcl_jrci_emitido;} ?> --}}">
                                        </div>
                                    </div>
                                </div>
                                <div class="row">
                                    <div class="col-6">
                                        <div class="form-group">
                                            <input type="submit" id="guardar_datos_recurso_jnci" class="btn btn-info" value="Guardar">
                                        </div>
                                    </div>
                                    <div class="col-12">
                                        <div class="alerta_controvertido alert alert-success mt-2 mr-auto d-none" role="alert"></div>
                                ...
                                <div class="row">
                                    <div class="col-4">
                                        <div class="form-group">
                                            ...
                                            <input type="text" class="form-control" name="n_acta_ejecutario_emitida_jrci" id="n_acta_ejecutario_emitida_jrci" value="{{-- <?php if(!empty($arrayinfo_controvertido[0]->Rango_pcl_jrci_emitido)) { echo $arrayinfo_controvertido[0]->Rango_pcl_jrci_emitido;} ?> --}}">
                                        </div>
                                    </div>
                                    <div class="col-4">
                                        <div class="form-group">
                                            <label for="f_acta_ejecutoria_emitida_jrci">Fecha Acta de Ejecutoría emitida por JRCI<span style="color: red;">(*)</span></label>
                                            <input type="date" class="form-control" name="f_acta_ejecutoria_emitida_jrci" id="f_acta_ejecutoria_emitida_jrci" max="{{now()->format('Y-m-d')}}" value="{{-- <?php if(!empty($arrayinfo_controvertido[0]->Rango_pcl_jrci_emitido)) { echo $arrayinfo_controvertido[0]->Rango_pcl_jrci_emitido;} ?> --}}">
                                        </div>
                                    </div>
                                    <div class="col-4">
                                        <div class="form-group">
                                            <label for="f_firmeza_dictamen_jrci">Fecha firmeza Dictamen<span style="color: red;">(*)</span></label>
                                            <input type="date" class="form-control" name="f_firmeza_dictamen_jrci" id="f_firmeza_dictamen_jrci" max="{{now()->format('Y-m-d')}}" value="{{-- <?php if(!empty($arrayinfo_controvertido[0]->Rango_pcl_jrci_emitido)) { echo $arrayinfo_controvertido[0]->Rango_pcl_jrci_emitido;} ?> --}}">
                                        </div>
                                    </div>
                                    <div class="col-12">
                                        <div class="form-group">
                                            <div class="custom-control custom-checkbox">
                                                <input class="custom-control-input" type="checkbox" id="dictamen_firme_jrci" name="dictamen_firme_jrci" value="Dictamen en firme" @if (!empty($arrayinfo_controvertido[0]->Contro_origen) && $arrayinfo_controvertido[0]->Contro_origen=='Origen') checked @endif>
                                ...
                                <div class="row">
                                    <div class="col-4">
                                        <div class="form-group">
                                            ...
                                            <input type="number" class="form-control soloNumeros" name="n_dictamen_jnci_emitido" id="n_dictamen_jnci_emitido" value="<?php if(!empty($arrayinfo_controvertido[0]->N_dictamen_jrci_emitido)) { echo $arrayinfo_controvertido[0]->N_dictamen_jrci_emitido;} ?>" required>
                                        </div>
                                    </div>
                                    <div class="col-4">
                                        <div class="form-group">
                                            <label for="f_dictamen_jnci_emitido">Fecha Dictamen (JNCI)<br><span style="color: red;">(*)</span></label>
                                            <input type="date" class="form-control" name="f_dictamen_jnci_emitido" id="f_dictamen_jnci_emitido" max="{{now()->format('Y-m-d')}}" value="<?php if(!empty($arrayinfo_controvertido[0]->F_dictamen_jrci_emitido)) { echo $arrayinfo_controvertido[0]->F_dictamen_jrci_emitido;} ?>" required>
                                        </div>
                                    </div>
                                   <div class="col-12">
                                        <form  id="form_diagnostico_emitido_jnci" method="POST">
                                    ...
                                    <div class="col-4">
                                        <div class="form-group">
                                            <br>
                                            <label for="origen_jrci_emitido">Origen Dx (JNCI)</label>
                                    ...
                                    <div <?php if(!empty($arrayinfo_controvertido[0]->Contro_pcl)){ ?> class="col-4" <?php }else{ ?> class="col-4 text-center d-none" <?php } ?>>
                                        <div class="form-group">
                                            ...
                                            <input type="number" class="form-control soloDosDecimales" name="total_deficiencia_jnci_emitido" id="total_deficiencia_jnci_emitido" value="<?php if(!empty($arrayinfo_controvertido[0]->Total_deficiencia_jrci_emitido)) { echo $arrayinfo_controvertido[0]->Total_deficiencia_jrci_emitido;} ?>">
                                        </div>
                                    </div>
                                    <div class="col-4 rol_ocupacional_jnci_emitido" <?php if(!empty($arrayinfo_controvertido[0]->Manual_de_califi_jrci_emitido) && $arrayinfo_controvertido[0]->Manual_de_califi_jrci_emitido=='1'){ ?> <?php }else{ ?>style="display:none"<?php } ?>>
                                        <div class="form-group" >
                                            <br>
                                            <label for="total_rol_ocupacional_jnci_emitido">Total Rol ocupacional (JNCI)<span style="color: red;">(*)</span></label>
                                            <input type="number" class="form-control soloDosDecimales" name="total_rol_ocupacional_jnci_emitido" id="total_rol_ocupacional_jnci_emitido" value="<?php if(!empty($arrayinfo_controvertido[0]->Total_rol_ocupacional_jrci_emitido)) { echo $arrayinfo_controvertido[0]->Total_rol_ocupacional_jrci_emitido;} ?>">
                                        </div>
                                    </div>
                                    <div class="col-4 total_discapaci_jnci_emitido" <?php if(!empty($arrayinfo_controvertido[0]->Manual_de_califi_jrci_emitido)&& $arrayinfo_controvertido[0]->Manual_de_califi_jrci_emitido=='3'){ ?> <?php }else{ ?>style="display:none"<?php } ?>>
                                        <div class="form-group">
                                            <br>
                                            <label for="total_discapacidad_jrci_emitido">Total Discapacidad (JNCI)<span style="color: red;">(*)</span></label>
                                            <input type="number" class="form-control soloDosDecimales" name="total_discapacidad_jnci_emitido" id="total_discapacidad_jnci_emitido" value="<?php if(!empty($arrayinfo_controvertido[0]->Total_discapacidad_jrci_emitido)) { echo $arrayinfo_controvertido[0]->Total_discapacidad_jrci_emitido;} ?>">
                                        </div>
                                    </div>
                                    <div class="col-4 total_minusva_jrci_emitido" <?php if(!empty($arrayinfo_controvertido[0]->Manual_de_califi_jrci_emitido)&& $arrayinfo_controvertido[0]->Manual_de_califi_jrci_emitido=='3'){ ?> <?php }else{ ?>style="display:none"<?php } ?>>
                                        <div class="form-group">
                                            ...
                                            <input type="number" class="form-control soloDosDecimales" name="total_minusvalia_jnci_emitido" id="total_minusvalia_jnci_emitido" value="<?php if(!empty($arrayinfo_controvertido[0]->Total_minusvalia_jrci_emitido)) { echo $arrayinfo_controvertido[0]->Total_minusvalia_jrci_emitido;} ?>">
                                        </div>
                                    </div>
                                    <div <?php if(!empty($arrayinfo_controvertido[0]->Contro_pcl)){ ?> class="col-4" <?php }else{ ?> class="col-4 text-center d-none" <?php } ?>>
                                        <div class="form-group">
                                            ...
                                            <input type="number" class="form-control" name="porcentaje_pcl_jnci_emitido" id="porcentaje_pcl_jnci_emitido" value="<?php if(!empty($arrayinfo_controvertido[0]->Porcentaje_pcl_jrci_emitido)) { echo $arrayinfo_controvertido[0]->Porcentaje_pcl_jrci_emitido;} ?>" readonly>
                                        </div>
                                    </div>
                                    <div <?php if(!empty($arrayinfo_controvertido[0]->Contro_pcl)){ ?> class="col-4" <?php }else{ ?> class="col-4 text-center d-none" <?php } ?>>
                                        <div class="form-group">
                                            ...
                                            <input type="text" class="form-control" name="rango_pcl_jnci_emitido" id="rango_pcl_jnci_emitido" value="<?php if(!empty($arrayinfo_controvertido[0]->Rango_pcl_jrci_emitido)) { echo $arrayinfo_controvertido[0]->Rango_pcl_jrci_emitido;} ?>" readonly>
                                        </div>
                                    </div>
                                   <div  <?php if(!empty($arrayinfo_controvertido[0]->Contro_pcl)){ ?> class="col-4" <?php }else{ ?> class="col-4 text-center d-none" <?php } ?>>
                                        <div class="form-group">
                                            ...
                                            <input type="date" class="form-control" name="f_estructuracion_contro_jnci_emitido" id="f_estructuracion_contro_jnci_emitido" max="{{now()->format('Y-m-d')}}" value="<?php if(!empty($arrayinfo_controvertido[0]->F_estructuracion_contro_jrci_emitido)) { echo $arrayinfo_controvertido[0]->F_estructuracion_contro_jrci_emitido;} ?>">
                                        </div>
                                    </div>
                                    <div class="col-12">
                                        <div class="form-group">
                                            <label for="resumen_dictamen_jnci">Resumen Dictamen (JNCI)</span></label>
                                            <textarea class="form-control soloPrimeraLetraMayus" name="resumen_dictamen_jnci" id="resumen_dictamen_jnci" cols="30" rows="5" style="resise:none;" required><?php if(!empty($arrayinfo_controvertido[0]->Resumen_dictamen_jrci)) { echo $arrayinfo_controvertido[0]->Resumen_dictamen_jrci;} ?></textarea>
                                        </div>
                                    </div>
                                    <div class="col-12">
                                        <div class="form-group">
                                            <label for="sustentacion_dictamen_jnci">Sustentación ante concepto de la (JNCI)</span></label>
                                            <textarea class="form-control soloPrimeraLetraMayus" name="sustentacion_dictamen_jnci" id="sustentacion_dictamen_jnci" cols="30" rows="5" style="resise:none;" required><?php if(!empty($arrayinfo_controvertido[0]->Resumen_dictamen_jrci)) { echo $arrayinfo_controvertido[0]->Resumen_dictamen_jrci;} ?></textarea>
                                        </div>
                                    </div>
                                    <div class="col-4">
                                        <div class="form-group">
                                            ...
                                            <input type="date" class="form-control" name="f_sustenta_ante_jnci" id="f_sustenta_ante_jnci" max="{{now()->format('Y-m-d')}}" value="<?php if(!empty($arrayinfo_controvertido[0]->F_noti_dictamen_jrci)) { echo $arrayinfo_controvertido[0]->F_noti_dictamen_jrci;} ?>">
                                        </div>
                                    </div>
                                    <div class="col-4">
                                        <div class="form-group">
                                            ...
                                            <input type="date" class="form-control" name="f_noti_ante_jnci" id="f_noti_ante_jnci" max="{{now()->format('Y-m-d')}}" value="<?php if(!empty($arrayinfo_controvertido[0]->F_noti_dictamen_jrci)) { echo $arrayinfo_controvertido[0]->F_noti_dictamen_jrci;} ?>">
                                        </div>
                                    </div>
                                    <div class="col-4">
                                        <div class="form-group">
                                            ...
                                            <input type="date" class="form-control" name="f_radica_dictamen_jnci" id="f_radica_dictamen_jnci" max="{{now()->format('Y-m-d')}}" value="<?php if(!empty($arrayinfo_controvertido[0]->F_radica_dictamen_jrci)) { echo $arrayinfo_controvertido[0]->F_radica_dictamen_jrci;} ?>">
                                        </div>
                                    </div>
                                </div>
                                <div class="row">

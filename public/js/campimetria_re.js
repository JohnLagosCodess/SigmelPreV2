$(document).ready(function() {
    ...
    $(document).on('submit', "form[id^='form_agudeza_visual']", function(e){
        ...
        let info_formulario = {
            "ID_evento_re": $("#ID_evento").val(),
            "Id_Asignacion_re": $("#Id_Asignacion").val(),
            "Id_proceso_re": $("#Id_proceso").val(),
            "Ceguera_Total_re": confirmacion_ceguera_total,
            "Agudeza_Ojo_Izq_re": $("#resultado_agudeza_ojo_izquierdo").val(),
            "Agudeza_Ojo_Der_re": $("#resultado_agudeza_ojo_derecho").val(),
            "Agudeza_Ambos_Ojos_re": $("#resultado_agudeza_ambos_ojos").val(),
            "PAVF_re": $("#resultado_pavf").val(),
            "DAV_re": $("#resultado_dav").val(),
            "Campo_Visual_Ojo_Izq_re": $("#resultado_campo_visual_ojo_izq").val(),
            "Campo_Visual_Ojo_Der_re": $("#resultado_campo_visual_ojo_der").val(),
            "Campo_Visual_Ambos_Ojos_re": $("#resultado_campo_visual_ambos_ojos").val(),
            "CVF_re": $("#resultado_cvf").val(),

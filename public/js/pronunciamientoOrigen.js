$(document).ready(function(){
    ...
    $("#listado_comunicados_pronu_origen").on('click', "#CorrespondenciaNotificacion", async function() {
        ...
        if (tipo_correspondencia.startsWith('afp_conocimiento')) {
            var datos_lista_tipos_documentos = guiasEntidadConocimiento (tipo_entidad_conocimiento, $("#Id_Evento_pronuncia").val(), 3, token, 'submodulo');
            $.ajax({
                type:'POST',
                url:'/selectoresPronunciamientoOrigen',
    ...
    $("#listado_comunicados_pronu_origen").on("click",'#editar_comunicado',function(){
    ...
    setTimeout(function() {
        radicados_duplicados('listado_comunicados_pronu_origen');
    ...
    $("#listado_tipos_documentos_guias").change(function(){
        ...
        var servicio = 3;
        var asignacion = $("#Asignacion_Pronuncia").val();

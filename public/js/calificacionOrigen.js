$(document).ready(function(){
    ...
    $(document).on('click', "[id^='replace_file']", function(){
        ...
        if(nombre_doc != null && nombre_doc != "null" && nombre_doc != undefined && this.getAttribute('data-tipo_descarga') !== 'Manual'){
...
function getHistorialNotificacion(n_radicado, nota,status_notificacion,data_comunicado) {
    ...
    console.log('antes',data_comunicado['enviar_notificacion']);

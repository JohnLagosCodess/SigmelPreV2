$(document).ready(function(){
    ...
    function capturar_informacion_comunicados(response, index, value, enviara) {
        ...
        let listadoComunicados =  $('#listado_comunicados_origen').DataTable({
    ...
    $("#listado_comunicados_origen").on("click",'#editar_comunicado',function(){
    ...
    $("#listado_comunicados_origen").on('click', "#CorrespondenciaNotificacion", async function() {
    ...
    setTimeout(function() {
        radicados_duplicados('listado_comunicados_origen');
    }, 500);
});
